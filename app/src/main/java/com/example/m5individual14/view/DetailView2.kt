package com.example.m5individual14.view
...
import com.example.m5individual14.components.Alert
import com.example.m5individual14.components.Boton
import com.example.m5individual14.components.CustomOutlinedTextField
import com.example.m5individual14.components.CustomOutlinedTextFieldTexto
import com.example.m5individual14.components.EspacioNormal
import com.example.m5individual14.components.MultiBoton
import com.example.m5individual14.components.Texto
import com.example.m5individual14.components.Titulo
import com.example.m5individual14.components.estadoSalud
...
fun ContentDetailView2(id:Int ,paddingValues: PaddingValues, viewModel: IMCViewModel) {
    Column(
        ...
        EspacioNormal()
        if (paciente != null) {
            CustomOutlinedTextField(paciente.edad, { edad = it }, "Edad")
            CustomOutlinedTextField(peso, { peso = it }, "Peso (kg)")
            CustomOutlinedTextField(altura, { altura = it }, "Altura (cm)")
            CustomOutlinedTextFieldTexto(paciente.nombre, { nombre = it }, "Nombre")
